      ...
      >
        ...
        <div className="flex items-center justify-between w-full">
          <div className="flex items-baseline gap-1.5">
            {/* Balance Text */}
            <h2 className="text-[28.76px] font-bold tracking-tight leading-none">
              {hideBalance ? '••••••' : balance.toFixed(2)}
            </h2>
            <span className="text-[13.11px] font-extrabold text-white/95 leading-none">TJS</span>
          </div>
        ...
        <div className="mt-4">
          <p className="text-[8.8px] font-mono tracking-wider text-white/70 antialiased">
            {lastRefreshedDate}
          </p>
        </div>
      </div>
